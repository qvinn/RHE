...
//            QFile* load_file(QString title, QString filter);
    ...
    class Waveform_Viewer_Widget : public QWidget {
        ...
        public:
            ...
            void re_scale_graph();
            void add_data_to_graph(QList<int> val, QList<int> *prev_vals, double time, double prev_debug_time, bool binary);
            void add_data_to_graph_rltm(QList<int> val, QList<int> *prev_vals, double time, double prev_debug_time, bool binary);
